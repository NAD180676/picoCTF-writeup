...
We made a lot of substitutions to encrypt this. Can you decrypt it? Connect with [this](nc.jupiter.challenges.picoctf.org:13758.)
...
The description meantioned **substitutions**, so in that case, let [the online decoder](https://www.guballa.de/substitution-solver) help: 
